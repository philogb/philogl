function webGLStart() {
  ...
  var triangle2 = new PhiloGL.O3D.Model({
    vertices: [ 1,  1, 0,
               -1, -1, 0,
                1, -1, 0],
  ...
  PhiloGL('lesson03-canvas-2', {
    ...
    onLoad: function(app) {
      ...
      function drawScene() {
        ...
        //Draw triangle
        triangle2.position.set(-1.5, 0, -7);
        triangle2.rotation.set(0, rTri, 0);
        setupElement(triangle2);
        gl.drawArrays(gl.TRIANGLES, 0, 3);

        //Draw Square
        square2.position.set(1.5, 0, -7);
        square2.rotation.set(rSquare, 0, 0);
        setupElement(square2);
        gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
      }
